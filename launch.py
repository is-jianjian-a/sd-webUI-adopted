...
{"Alternatively, use a binary release of WebUI: https://kgithub.com/AUTOMATIC1111/stable-diffusion-webui/releases" if is_windows else ""}
...
def version_check(commit):
    try:
        import requests
        commits = requests.get('https://api.kgithub.com/repos/AUTOMATIC1111/stable-diffusion-webui/branches/master').json()
...
def prepare_environment():
    ...
    gfpgan_package = os.environ.get('GFPGAN_PACKAGE', "git+https://kgithub.com/TencentARC/GFPGAN.git@8d2447a2d918f8eba5a4a01463fd48e45126a379")
    ...
    taming_transformers_repo = os.environ.get('TAMING_TRANSFORMERS_REPO', "https://kgithub.com/CompVis/taming-transformers.git")
    ...
    if (not is_installed("xformers") or reinstall_xformers) and xformers:
        if platform.system() == "Windows":
            if platform.python_version().startswith("3.10"):
                ...
                print("You can also check this and build manually: https://kgithub.com/AUTOMATIC1111/stable-diffusion-webui/wiki/Xformers#building-xformers-on-windows-by-duckness")
