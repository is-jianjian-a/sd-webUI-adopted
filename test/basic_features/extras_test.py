...
class TestPngInfoWorking(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.png_info = {"image": encode_pil_to_base64(Image.open(os.path.join(script_path, r"test/test_files/img2img_basic.png")))}
...
class TestInterrogateWorking(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.interrogate = {"image": encode_pil_to_base64(Image.open(os.path.join(script_path, r"test/test_files/img2img_basic.png"))), "model": "clip"}
